<div class="container center-screen pt-2">
    <div class="card shadow-sm entity-card w-100">
        <div class="card-header bg-danger text-white">
            <h3 class="mb-0">Eliminar municipio</h3>
        </div>
        <div class="card-body">
            <div class="delete-warning">
                <h5>
                    <i class="bi bi-exclamation-triangle-fill me-2"></i>
                    Estas seguro de que quieres eliminar este <strong>municipio</strong>?
                </h5>
            </div>
                ...
                <dl class="row">
                    <div class="fields-grid">
                        <div class="field-item">
                            <label for="municipality_name" class="field-label">Nombre del municipio</label>
                            <div id="municipality_name" name="municipality_name" class="field-value"><?= $municipality['municipality_name']; ?></div>
                        </div>
                        <div class="field-item">
