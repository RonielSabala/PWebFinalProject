<div class="container center-screen pt-2 mb-3">
    <div class="card shadow-sm entity-card w-100" style="max-width: 1000px;">
        <div class="card-header bg-success text-white">
            <h3 class="mb-0">Crear nuevo municipio</h3>
        </div>
        <div class="card-body">
            ...
            <form method="post">
                <div class="edit-grid">
                    ...
                    <div class="edit-item">
                        ...
                        <input type="text" id="municipality_name" name="municipality_name" class="form-control" placeholder="Escribe el nombre del municipio" required>
                    </div>
                </div>
