<div class="container center-screen pt-2 mb-3">
    <div class="card shadow-sm entity-card w-100" style="max-width: 1000px;">
        <div class="card-header bg-warning text-dark">
            <h3 class="mb-0">Editar provincia</h3>
        </div>
        <div class="card-body">
            ...
            <form method="post">
                <div class="edit-grid">
                    <div class="edit-item">
                        ...
                        <input type="text" id="province_name" name="province_name" class="form-control" placeholder="Escribe el nombre de la provincia" value="<?= $province['province_name']; ?>" required>
                    </div>
                </div>
