<div class="container center-screen pt-2">
    <div class="card shadow-sm entity-card w-100">
        <div class="card-header bg-danger text-white">
            <h3 class="mb-0">Eliminar provincia</h3>
        </div>
        <div class="card-body">
            <div class="delete-warning">
                <h5>
                    <i class="bi bi-exclamation-triangle-fill me-2"></i>
                    Estas seguro de que quieres eliminar esta <strong>provincia</strong>?
                </h5>
            </div>
                ...
                <dl class="row">
                    <div class="fields-grid">
                        <div class="field-item">
                            <label for="province_name" class="field-label">Nombre de la provincia</label>
                            <div id="province_name" name="province_name" class="field-value"><?= $province['province_name']; ?></div>
                        </div>
                    </div>
                </dl>
